...
namespace Beetle
{
    public partial class MainForm : Form
    {
        ...
        private static bool tabBC = false; // whether on Beetle Control tab
        ...
        private void buttonPiezoSearch_Click(object sender, EventArgs e)
        {
            ...
            runThread = new Thread(BA.PiezoSearchRun);
            runThread.Start();
        }
