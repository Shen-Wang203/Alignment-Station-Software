        ...
        protected bool PiezoSteppingSearch(byte axis, bool targetLess = false)
        {
            ...
            while (!Parameters.errorFlag)
            {
                ...
                if (axis == 0)
                    ...
                    p = (ushort)(Parameters.piezoPosition[axis] + Parameters.piezoStepSize * 3 * zDirectionTrend);
                ...
                else
                {
                    ...
                    if (sameCount >= 18)
                    {
                        if (axis == 0)
                            ...
                            p = (ushort)(Parameters.piezoPosition[axis] - Parameters.piezoStepSize * 3 * zDirectionTrend * 6);
                        Console.WriteLine("Exit Due to Same Loss");
                        Parameters.Log("Exit Due to Same Loss");
                        break;
                    }
