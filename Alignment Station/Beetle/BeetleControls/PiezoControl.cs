...
namespace Beetle
{
    ...
    // The arrow on the piezo represents the direction when DAC value increases.
    class PiezoControl
    {
        ...
        // total command has two byte, 0x#***, where the # position is ch (0-2) and * positions is the code
